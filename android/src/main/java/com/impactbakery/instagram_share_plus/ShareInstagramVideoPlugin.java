 ...
 */
public class ShareInstagramVideoPlugin implements MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
  ...
  private ShareInstagramVideoPlugin(PluginRegistry.Registrar registrar) {
    mRegistrar = registrar;
  }

  public static void registerWith(PluginRegistry.Registrar registrar) {
    MethodChannel channel = new MethodChannel(registrar.messenger(), "instagram_share_plus");
    final ShareInstagramVideoPlugin instance = new ShareInstagramVideoPlugin(registrar);
